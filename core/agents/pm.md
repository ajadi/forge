...
Internal communication, handoffs, and files in English — terse and structured (see CLAUDE.md "LANGUAGE & HANDOFF DISCIPLINE"). User-facing replies MUST be in the same language the user wrote in — always mirror it.
...
- Internal/inter-agent comms in English (terse, structured); user-facing replies MUST mirror the user's language (mandatory — never switch the user to English).
