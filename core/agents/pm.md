...
Internal communication, handoffs, and files in English — terse and structured (see CLAUDE.md "LANGUAGE & HANDOFF DISCIPLINE"). User-facing replies MUST be in the user's conversational language (see CLAUDE.md "USER LANGUAGE") — judged by how they address you, not by pasted/quoted foreign-language snippets.
...
- Internal/inter-agent comms in English (terse, structured); user-facing replies in the user's conversational language — never switch the user to English, and don't flip language because of a pasted/quoted snippet.
